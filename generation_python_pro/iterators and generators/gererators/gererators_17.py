...
# последовательностей: сначала первый элемент первой последовательности,
# затем первый элемент второй последовательности, и так далее;
# после второй элемент первой последовательности, затем второй элемент второй последовательности,
# и так далее.
#
...
# содержащую только необходимую функцию interleave(), но не код, вызывающий ее.


def interleave(*args):
    yield from (el for arg in zip(*args) for el in arg)
