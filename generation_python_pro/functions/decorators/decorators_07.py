...
# кортеж (None, 'При вызове функции произошла ошибка'), если при
# выполнении декорируемой функции возникла ошибка
...
# декоратор exception_decorator, но не код, вызывающий его.
