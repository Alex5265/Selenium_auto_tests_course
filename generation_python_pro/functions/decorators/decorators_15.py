...
#
# Примечание 4. В тестирующую систему сдайте программу, содержащую только необходимый
# декоратор strip_range, но не код, вызывающий его.
import functools
...
def strip_range(start, end, char='.'):
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            return f'{result[:start]}{char * len(result[start:end])}{result[end:]}'
