...
# должен создавать файл numbers.pkl,
# содержащий сериализованный список [1, 3, 4].
#
# Примечание 2. В тестирующую систему сдайте программу,
# содержащую только необходимую функцию filter_dump(),
...
def filter_dump(filename, objects, typename):
    with open(filename, 'wb') as file:
        filter_obj = list(filter(lambda x: isinstance(x, typename), objects))
        pickle.dump(filter_obj, file)
