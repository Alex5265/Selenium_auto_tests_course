...
# решили сыграть в игру. Ребята по очереди достают из ящика произвольное количество носков,
...
mans = ['Анри', 'Дима']
date = [int(i) for i in sys.stdin]
man = len(date) % 2
socks = date.pop()
if not man % 2 and not socks % 2:
    print(mans[1])
elif man % 2 == 1 and socks % 2:
    print(mans[1])
else:
    print(mans[0])
