...
# Программа должна определить рост самого низкого
# и самого высокого учеников, а также средний рост среди всех учеников.
#
...
stydi = list(map(int, sys.stdin))
if not stydi:
    print('нет учеников')
else:
    print(f'Рост самого низкого ученика: {min(stydi)}')
    print(f'Рост самого высокого ученика: {max(stydi)}')
    print(f'Средний рост: {sum(stydi) / len(stydi)}')
