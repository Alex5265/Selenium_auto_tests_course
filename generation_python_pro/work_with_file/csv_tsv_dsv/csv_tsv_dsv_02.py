...
with open('writing_test.csv', 'w', encoding='utf-8', newline='') as csv_file: # добавил newline=''
    ...
    writer.writerow({'first_col': 'value1', 'second_col': 'value2'}) # изменил название ключей в словаре
