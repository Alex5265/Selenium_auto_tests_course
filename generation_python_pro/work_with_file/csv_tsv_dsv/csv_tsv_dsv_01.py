...
# Timur;100
# Ruslan;97
# Ниже представлена программа, которая должна открывать
# данный файл и выводить содержимое каждой строки в виде списка.
...
with open('grades.csv', encoding='utf-8') as csv_file:
    ...
    #text = csv_file.read() - # лишняя строка нет необходимост считывать файл
