#! данный код скопирован у Купченко Ярослава из курса на степике. Неоьпытному взгляду понравилась реализация
# в дальнейшем планируется сделать пдебаг с веткой в гите. именно для этого и копируется код.
#! This code was copied from Yaroslav Kupchenko from the steppe course. The untrained eye liked the implementation
# in the future we plan to make a debug with a branch in git. This is exactly why the code is copied.
