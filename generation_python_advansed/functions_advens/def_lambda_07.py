...
words = ['beverage', 'monday', 'abroad', 'bias', 'abuse', 'abolish', 'abuse',
         ...
         'berth', 'beyond', 'benevolent', 'abate', 'abide', 'bicycle', 'beside',
         'accept', 'berry', 'bewilder', 'abrupt', 'saturday', 'accessory', 'absorb']


#после предыдущего задание все просто - ламбде функции задаем условие о длине слова
