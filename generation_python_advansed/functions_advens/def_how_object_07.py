...
# в отличии от предыдущей задачи сначала сортрируем по int а потом по функции
...
# функция компаратор возвращает несколько значений
# - сумма элементов(только тут двойное превращение - число превращается в строку
# а сумма вычисляется перебором
# и превращением элемента в int
