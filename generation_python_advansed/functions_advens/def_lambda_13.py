...
# разбил сразу на цвета хотя нет необходимости. т.к. цвета не могут быть более 255
# достаточно реалзовать ламба функции которая ищет модуль в кором вычитается из 255 само значение
r,g,b = map(lambda x: abs(255 - int(x)), input().split())
print(r, g, b)
